exports.seed = (knex) => {
  ...
  return knex('transactions').del()
    ...
    .then(() => knex('users').insert([
      {
        id: 10000, name: 'User #1', mail: 'user1@mail.com', passwd: '$2b$10$SguRo7.ZkE/jOWjp1zDdnu210Chj5XUMLoCWnwJqzf.fwS.o/r576',
      },
      {
        id: 20000, name: 'User #2', mail: 'user2@mail.com', passwd: '$2b$10$SguRo7.ZkE/jOWjp1zDdnu210Chj5XUMLoCWnwJqzf.fwS.o/r576',
      },
    ]))
    .then(() => knex('accounts').insert([
      { id: 10000, name: 'Acc0 #1', user_id: 10000 },
      { id: 10001, name: 'AccD #1', user_id: 10000 },
      { id: 10002, name: 'Acc0 #1', user_id: 20000 },
      { id: 10003, name: 'AccD #1', user_id: 20000 },
    ]))
    .then(() => knex('transfers').insert([
      ...
      {
        id: 10001, description: 'Transfer #2', user_id: 20000, acc_ori_id: 10002, acc_dest_id: 10003, ammount: 100, date: new Date(),
      },
    ]))
